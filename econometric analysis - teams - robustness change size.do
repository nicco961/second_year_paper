...
keep if initial_members>1.99 & initial_members<5
...
keep if initial_members>10 & initial_members<75
...
keep if job_description_code==15
keep if initial_members>5 & initial_members<20
...
graph export "C:\Users\nicco\OneDrive\Desktop\On the job training and career outcomes\dataset\do file analysis\figures\robustness checks\change size\robustness_table_team_event_study_size_tasks.png", as(png) name("Graph") replace
